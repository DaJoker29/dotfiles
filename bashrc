...
# Add git completion
source /home/dajoker29/source/git/contrib/completion/git-completion.bash
source /home/dajoker29/source/git/contrib/completion/git-prompt.sh
...
export PS1=$Green[$Time12h]$Space$BBlue$Username$Blue@$Host$Color_Off'$(git branch &>/dev/null;\
    if [ $? -eq 0 ]; then \
